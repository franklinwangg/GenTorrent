...
SERVE_WORKERS = 256
REQUEST_RATE = 72
DATASET_PATH = "../datasets/prompt_dataset.txt"
...
async def sched_worker():
    ...
    while True:
        ...
        ids = tokenizer(sample["prompt"], return_tensors="pt")["input_ids"][0].tolist()
